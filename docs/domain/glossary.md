...
### Canonical docs
Durable source-of-truth documentation that humans and agents can rely on repeatedly. In this template, canonical docs live in `README.md`, `AGENTS.md`, and the main sections under `docs/`.
...
### Promotion rule
The rule that temporary or inferred knowledge must be promoted into a canonical document before the team relies on it long term.
